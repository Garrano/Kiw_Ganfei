# -*- coding: utf-8 -*-
"""F14 — o plano. Onde ir, o que colher, e o que cada ponto decide.
...
ax.text(zx, zy - 172,
        ...
        ha="center", va="top", fontsize=8.5, color=T1C, linespacing=1.55,
...
axd.text(0.005, y - 0.052,
         ...
         "a pergunta regional como CONDIÇÃO DE ARRANQUE, não como tarefa",
...
fig.savefig(os.path.join(AQUI, "F14_plano.png"), facecolor=FUNDO,
            bbox_inches="tight", pad_inches=0.34)
fig.savefig(os.path.join(AQUI, "F14_plano.svg"), facecolor=FUNDO,
            bbox_inches="tight", pad_inches=0.34)
print("escrito F14 — %d plantas, %d amostras, matrizes: %s" % (n_pl, n_am, mat))
